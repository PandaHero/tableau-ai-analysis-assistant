...
Contains:
- AnalystLLMOutput: LLM output model for Analyst prompt
...
class AnalystLLMOutput(BaseModel):
    """Analyst LLM output model - list of insights.
    
    <what>List of insights generated by analyst LLM</what>
    """
    model_config = ConfigDict(extra="forbid")
    
    insights: List[Insight] = Field(
        description="""<what>List of insights</what>
<when>ALWAYS required</when>
<how>2-5 insights, sorted by importance</how>"""
    )
