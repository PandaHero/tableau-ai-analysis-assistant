...
参考 DB-GPT 的 DBSchemaAssembler 实现模式，提供元数据加载和检索器创建能力。
...
from tableau_assistant.src.capabilities.rag.models import FieldChunk, RetrievalResult
...
from tableau_assistant.src.models.metadata import FieldMetadata, Metadata
