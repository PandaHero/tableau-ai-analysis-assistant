...
class FieldValueIndexer:
    ...
    def _create_embedding_provider(self) -> Optional[Any]:
        """创建 Embedding 提供者"""
        try:
            from tableau_assistant.src.infra.ai.rag.embeddings import EmbeddingProviderFactory
            from tableau_assistant.src.infra.ai.rag.cache import CachedEmbeddingProvider
