...
- Rerank 日志：记"before/after rankings "score changes
...
class RerankLogEntry:
    ...
    **Validates: Requirements 8.2**
    ...
    Attributes:
        query_text: 查询文本
        before_ranking: 重排序前的排"
        after_ranking: 重排序后的排"
        score_changes: 分数变化
        latency_ms: 延迟（毫秒）
...
class RAGMetrics:
    ...
    **Validates: Requirements 8.5**
    ...
    Attributes:
        total_queries: 总查询数
        total_retrieval_latency_ms: 总检索延"
        cache_hits: 缓存命中"
        ...
        total_disambiguation_latency_ms: 总消歧延"
        rerank_count: 重排序次"
